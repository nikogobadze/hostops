...
const SLOTS = [
  ...
  { key: 'hero-dining', wide: true, must: ['restaurant', 'table', 'dining', 'food', 'dinner'],
    q: ['elegant restaurant dining room', 'restaurant table setting candle', 'fine dining room interior'] },
  ...
  { key: 'room-junior', must: ['suite', 'room', 'living', 'sofa', 'hotel'],
    q: ['living room sofa interior', 'lounge interior sofa', 'sitting room interior'] },
  { key: 'room-family', must: ['room', 'bed', 'hotel', 'family'],
    q: ['family hotel room beds', 'hotel room multiple beds', 'bedroom beds interior'] },
  { key: 'room-penthouse', must: ['terrace', 'balcony', 'penthouse', 'view', 'suite'],
    q: ['penthouse terrace view', 'balcony terrace sea', 'rooftop terrace suite'] },
  ...
  { key: 'dining-terrace', must: ['terrace', 'garden', 'restaurant', 'outdoor', 'cafe'],
    q: ['outdoor terrace table', 'cafe terrace chairs', 'garden table outdoor'] },
  { key: 'dining-rooftop', must: ['bar', 'cocktail', 'rooftop', 'drink', 'sunset'],
    q: ['cocktail bar drink', 'rooftop bar view', 'bar counter drinks'] },
